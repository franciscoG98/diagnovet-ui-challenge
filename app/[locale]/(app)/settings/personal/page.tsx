    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="space-y-6">
        ...
        <SectionCard
          ...
          subtitle="Your basic profile information and account details."
          icon={User}
        ...
        >
          <div className="flex items-center gap-6">
            ...
            <div>
              <h4 className="text-xl font-semibold text-foreground">Fernanda Barbero</h4>
              <div className="flex items-center gap-2 text-sm text-muted-foreground mt-1">
                <Calendar className="w-4 h-4" />
                Member since 11/20/2025
              </div>
              <Badge variant="secondary" className="mt-2 bg-teal-light text-teal border-teal/20">
                <Building2 className="w-3 h-3 mr-1" />
                DIVET Veterinary Diagnostic Center
              </Badge>
            </div>
          </div>
        </SectionCard>
        ...
        {/* Contact Information */}
        <SectionCard title="Contact Information" icon={Mail} iconColor="bg-blue-100 text-blue-600">
